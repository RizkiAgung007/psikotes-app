...
// Import Icon Lucide (Sama seperti Create)
import {
    Save,
    Pencil, // Ganti icon plus jadi pencil
    ArrowLeft,
    Trash2,
    Layers,
    HelpCircle,
...
export default function Edit({ auth, categories, modules, question }) {
    // QUESTION adalah data soal lama yang dikirim Controller

    // Setup form dengan DATA LAMA (Pre-filled)
    const { data, setData, put, processing, errors } = useForm({
        module_id: question.module_id,
        question_text: question.question_text,
        // Kita harus mapping opsi dari database ke format form kita
        // DB: option_text -> Form: text
    ...
    const submit = (e) => {
        e.preventDefault();
        // PENTING: Gunakan PUT untuk update, dan arahkan ke route update dengan ID
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-xl border border-gray-100">
                        <div className="p-8">
                            <form onSubmit={submit}>
                                {/* HEADER SECTION: Modul & Pertanyaan */}
                                ...
                                <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                                    ...
                                    {/* Tombol Simpan Perubahan (Hanya 1 tombol) */}
                                    <button
                                        type="submit"
                                        disabled={processing}
